// /*
//  – initializes the internal blackbox data structures. Should be called in the
...
// //  – returns the number of equations (which is equal to the number of
// // unknowns) of the system. The number of equations lies between 10 and 10000 (inclusive).
// int blackbox_size();


// //  – compute the product of A and vector x,
